		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<div class="inner-block">
					<div class="blank">
						<h2><%= erro!=null?"<font color=\"red\">"+erro+"</font>":"" %>Nova Ordem de Serviço</h2>
						<div class="inbox-details-body">
							...
							<form action="cadastrarOS" method="post">
								<div class="col-xs-12 market-update-gd">
									<input type="text" name="idCli" id="idCli" placeholder="Codigo do Cliente" value="<%= cli!=null?cli.getCliente_id():""%>">
							...
							<form action="cadastrarOS" method="post">
								<div class="col-md-6 market-update-gd">
									<input type="hidden" id="idCli" name="idCli" value="<%= cli!=null?cli.getCliente_id():""%>">
								...
								<div class="col-md-6 market-update-gd">
									<input type="text" name="tpEquip" id="tpEquip" placeholder="Tipo do Equipamento:">
								</div>
								<div class="col-md-6 market-update-gd">
									<input type="text" name="marcaEquip" id="marcaEquip" placeholder="Marca do Equipamento">
								</div>
								
								<div class="col-xs-12 market-update-gd">
									<textarea name="problema" id="problema" placeholder="Problema apresentado:" rows="10" cols="40" maxlength="500"></textarea>
								</div>
								
								<div class="col-xs-12 market-update-gd">
									<textarea name="executado" id="executado" placeholder="Execução:" rows="10" cols="40" maxlength="500"></textarea>
								</div>
								<div class="col-md-6 market-update-gd">
